...
write.csv(Idents(sc8),"/Users/kyokasuyama/Desktop/Xenium/csv/sc0forXenium.csv")
sc1 <- subset(P0P6Astglineage,idents = 1)
write.csv(Idents(sc9),"/Users/kyokasuyama/Desktop/Xenium/csv/sc1forXenium.csv")
sc2 <- subset(P0P6Astglineage,idents = 2)
write.csv(Idents(sc8),"/Users/kyokasuyama/Desktop/Xenium/csv/sc2forXenium.csv")
sc3 <- subset(P0P6Astglineage,idents = 3)
write.csv(Idents(sc9),"/Users/kyokasuyama/Desktop/Xenium/csv/sc3forXenium.csv")
sc4 <- subset(P0P6Astglineage,idents = 4)
write.csv(Idents(sc8),"/Users/kyokasuyama/Desktop/Xenium/csv/sc4forXenium.csv")
sc5 <- subset(P0P6Astglineage,idents = 5)
write.csv(Idents(sc9),"/Users/kyokasuyama/Desktop/Xenium/csv/sc5forXenium.csv")
sc6 <- subset(P0P6Astglineage,idents = 6)
write.csv(Idents(sc8),"/Users/kyokasuyama/Desktop/Xenium/csv/sc6forXenium.csv")
sc7 <- subset(P0P6Astglineage,idents = 7)
write.csv(Idents(sc9),"/Users/kyokasuyama/Desktop/Xenium/csv/sc7forXenium.csv")
